<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="information.aspx.cs" Inherits="ResumeMaker.information1" %>
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <asp:TextBox ID="TextDOB" runat="server" CssClass="form-control mt-3" placeholder="Date of Birth"></asp:TextBox>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 pt-3">
                                                                Gender:<asp:RadioButton ID="RadioButton1" runat="server" Text="Male" GroupName="gender"></asp:RadioButton>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtPercentage" runat="server" CssClass="form-control mt-3" placeholder="Percentage"></asp:TextBox></h6>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtPGPercentage" runat="server" CssClass="form-control mt-3" placeholder="Percentage"></asp:TextBox></h6>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <asp:TextBox ID="txtGniversityName" runat="server" CssClass="form-control" placeholder="University Name"></asp:TextBox>
                                                            </div>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtGPercentage" runat="server" CssClass="form-control mt-3" placeholder="Percentage"></asp:TextBox></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtHSCPercentage" runat="server" CssClass="form-control mt-3" placeholder="Percentage"></asp:TextBox></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtSSCPercentage" runat="server" CssClass="form-control mt-3" placeholder="Percentage"></asp:TextBox></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="cal-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control mt-3" placeholder="Status "></asp:TextBox>
                                                            </div>
                                                        </div>
                                ...
                                <div class="tab-pane fade show" id="tab4">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button type="submit"><a href="selectTemplates.html">Select Template</a></button>
